...
- Workflow artifact named `coverage-report` containing:
  - `coverage.xml`
  - `coverage.md`
- Generated badge file in workflow artifacts at `.github/badges/coverage.svg`
- Badge timestamp file in workflow artifacts at `.github/badges/coverage-updated.txt`
